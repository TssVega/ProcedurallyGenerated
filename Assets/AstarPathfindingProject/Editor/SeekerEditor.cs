...
namespace Pathfinding {
	...
	public class SeekerEditor : EditorBase {
		...
		GUIContent[] exactnessLabels = { new GUIContent("Node Center (Snap To Node)"), new GUIContent("Original"), new GUIContent("Interpolate (deprecated)"), new GUIContent("Closest On Node Surface"), new GUIContent("Node Connection") };
